        ...
        <div className="flex flex-col gap-4">
          {[1, 2, 3, 4].map((s, index) => (
            <div key={index} className="flex items-center gap-3">
              ...
              <span
                className={`font-medium ${step === s ? "text-gray-900" : "text-gray-500"}`}
              >
                {s === 1
                  ? "Business Type"
                  : s === 2
        ...
        <Card>
          <div className="mb-8">
            <h1 className="text-2xl font-bold mb-2">
              Find out what approvals you need
            </h1>
            <p className="text-gray-600">
              Answer a few questions about your business and we'll show you the
