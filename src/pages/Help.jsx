    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-gray-600">
          Need assistance? Here are the ways you can get help with your
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card className="text-center p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Send us your query and we'll reply within 2 working days.
          </p>
          <a
            href="mailto:hospohub@aucklandcouncil.govt.nz"
        ...
        <Card className="text-center p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Chat with our licensing specialists online.
          </p>
      ...
      <Card>
        ...
        <div className="space-y-4">
          {[
            ...
            <details
              key={i}
              className="group bg-gray-50 rounded-md"
            >
              ...
              <div className="text-gray-600 px-4 pb-4 text-sm">
                ...
                In a real application, this would contain detailed guidance from
                Auckland Council regarding {q.toLowerCase()}
              </div>
            </details>
          ))}
        </div>
